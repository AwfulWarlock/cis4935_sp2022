...
then
	...
	time (seq 1 $num | xargs -n 1 -P $num curl --http3 https://172.31.81.42/img/image.jpg -ks -o /dev/null)
    fi # Inner IF
else
	...
	time (seq 1 $num | xargs -n 1 -P $num curl --http2 https://172.31.81.42/img/image.jpg -ks -o /dev/null)
